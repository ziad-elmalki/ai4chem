...
project = "ai4chemistry"
copyright = f"{date.today().year}, Ziad El Malki"
author = "Ziad El Malki"
...
modindex_common_prefix = ["ai4chemistry."]
...
htmlhelp_basename = "ai4chemistry_doc"
